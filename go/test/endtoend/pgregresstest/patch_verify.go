...
func GetPatchMode() PatchMode { _ = "STUB: not implemented"; return *new(PatchMode) }
...
func normalizeWhitespace(input []byte) []byte { _ = "STUB: not implemented"; return nil }
...
func relForReport(repoRoot, path string) string { _ = "STUB: not implemented"; return "" }
